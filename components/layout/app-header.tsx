...
const ROLE_CONFIG = {
  owner: {
    label: "Propriétaire",
    profilePath: "/app/owner/profile",
    settingsPath: "/app/owner/settings",
    messagesPath: "/app/owner/messages",
    supportPath: "/app/owner/support",
  },
  tenant: {
    label: "Locataire",
    profilePath: "/app/tenant/settings",
    settingsPath: "/app/tenant/settings",
    messagesPath: "/app/tenant/messages",
    supportPath: "/app/tenant/help",
  },
  provider: {
    label: "Prestataire",
    profilePath: "/app/provider/profile",
    settingsPath: "/app/provider/settings",
    messagesPath: "/app/provider/messages",
    supportPath: "/app/provider/help",
  },
  syndic: {
    label: "Syndic",
    profilePath: "/app/syndic/profile",
    settingsPath: "/app/syndic/settings",
    messagesPath: "/app/syndic/messages",
    supportPath: "/app/syndic/help",
  },
};
