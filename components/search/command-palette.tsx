    ...
    () => [
      {
        ...
        icon: BarChart3,
        shortcut: "⌘D",
        action: () => navigate("/app/owner/dashboard"),
      ...
      },
      {
        ...
        icon: Building2,
        shortcut: "⌘B",
        action: () => navigate("/app/owner/properties"),
      ...
      },
      {
        ...
        icon: FileText,
        shortcut: "⌘C",
        action: () => navigate("/app/owner/contracts"),
      ...
      },
      {
        ...
        icon: Receipt,
        shortcut: "⌘F",
        action: () => navigate("/app/owner/money"),
      ...
      },
      {
        ...
        label: "Documents",
        icon: FolderOpen,
        action: () => navigate("/app/owner/documents"),
      ...
      },
      {
        ...
        label: "Maintenance",
        icon: Ticket,
        action: () => navigate("/app/owner/tickets"),
      ...
      // Actions rapides
      {
        ...
        icon: Plus,
        shortcut: "⌘N",
        action: () => navigate("/app/owner/properties/new"),
      ...
      },
      {
        ...
        icon: Plus,
        action: () => navigate("/app/owner/contracts/new"),
      ...
      },
      {
        ...
        icon: Receipt,
        action: () => navigate("/app/owner/money/new"),
        keywords: ["quittance", "loyer"],
        group: "actions",
      },
      {
        id: "rent-calculator",
        label: "Calculateur de loyer",
        icon: Calculator,
        action: () => navigate("/app/owner/tools/calculator"),
        keywords: ["simulation", "rentabilité"],
        group: "tools",
      },
    ],
    [navigate]
    ...
    () => [
      {
        ...
        icon: BarChart3,
        shortcut: "⌘D",
        action: () => navigate("/app/tenant/dashboard"),
      ...
      },
      {
        ...
        label: "Mon bail",
        icon: FileText,
        action: () => navigate("/app/tenant/lease"),
      ...
      },
      {
        ...
        label: "Mes paiements",
        icon: Receipt,
        action: () => navigate("/app/tenant/payments"),
      ...
      },
      {
        ...
        label: "Mes demandes",
        icon: Ticket,
        action: () => navigate("/app/tenant/requests"),
      ...
      },
      {
        ...
        label: "Documents",
        icon: FolderOpen,
        action: () => navigate("/app/tenant/documents"),
        keywords: ["fichiers"],
        group: "navigation",
      },
      {
        ...
        icon: Plus,
        action: () => navigate("/app/tenant/requests/new"),
