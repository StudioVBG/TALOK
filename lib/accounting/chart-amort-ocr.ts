...
export const PCG_OWNER_ACCOUNTS = [
  ...
  { account_number: '101000', label: 'Capital social SCI', account_type: 'equity' as const },
  { account_number: '106000', label: 'Reserves', account_type: 'equity' as const },
  { account_number: '110000', label: 'Report a nouveau (solde crediteur)', account_type: 'equity' as const },
  { account_number: '120000', label: 'Resultat de l\'exercice', account_type: 'equity' as const },
  ...
  { account_number: '168000', label: 'Autres emprunts et dettes assimilees', account_type: 'liability' as const },
  // Classe 2 — Immobilisations (CRITIQUE: requis pour le bilan)
  { account_number: '211000', label: 'Terrains', account_type: 'asset' as const },
  { account_number: '213100', label: 'Immeuble — gros oeuvre', account_type: 'asset' as const },
  { account_number: '213200', label: 'Immeuble — facade et etancheite', account_type: 'asset' as const },
  { account_number: '213300', label: 'Immeuble — installations generales', account_type: 'asset' as const },
  { account_number: '214100', label: 'Agencements et amenagements', account_type: 'asset' as const },
  { account_number: '215100', label: 'Equipements et installations techniques', account_type: 'asset' as const },
  { account_number: '218000', label: 'Autres immobilisations corporelles', account_type: 'asset' as const },
  // Amortissements (contre-actifs)
  { account_number: '281310', label: 'Amort. immeuble — gros oeuvre', account_type: 'liability' as const },
  { account_number: '281320', label: 'Amort. immeuble — facade', account_type: 'liability' as const },
  { account_number: '281330', label: 'Amort. immeuble — installations', account_type: 'liability' as const },
  { account_number: '281410', label: 'Amort. agencements', account_type: 'liability' as const },
  { account_number: '281510', label: 'Amort. equipements', account_type: 'liability' as const },
  // Classe 4 — Tiers
  { account_number: '401000', label: 'Fournisseurs', account_type: 'liability' as const },
  { account_number: '406000', label: 'Fournisseurs — factures non parvenues', account_type: 'liability' as const },
