 ...
 *
 * NOTE: Les schémas *UpdateSchema utilisent .optional() explicite sur chaque champ
 * au lieu de .partial() pour éviter les erreurs de bundling Next.js.
 */
...
// Version partielle pour les mises à jour (champs explicitement optionnels)
...
// Version partielle pour les mises à jour (tous les champs déjà optionnels)
...
// Version partielle pour les mises à jour (champs explicitement optionnels + validation)
...
// Schéma de base (sans superRefine) pour permettre les extensions
