/**
 * Email template: ec-annotation
 */
export function ecannotationEmail(params: Record<string, string>) {
  ...
  const t = templates["ec-annotation"] ?? { subject: "Notification Talok", body: "" };
