/**
 * Email template: declaration-ready
 */
export function declarationreadyEmail(params: Record<string, string>) {
  ...
  const t = templates["declaration-ready"] ?? { subject: "Notification Talok", body: "" };
