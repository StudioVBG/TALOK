/**
 * Email template: deficit-reported
 */
export function deficitreportedEmail(params: Record<string, string>) {
  ...
  const t = templates["deficit-reported"] ?? { subject: "Notification Talok", body: "" };
