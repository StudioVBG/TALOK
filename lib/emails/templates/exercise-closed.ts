/**
 * Email template: exercise-closed
 */
export function exerciseclosedEmail(params: Record<string, string>) {
  ...
  const t = templates["exercise-closed"] ?? { subject: "Notification Talok", body: "" };
