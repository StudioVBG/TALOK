/**
 * Email template: deficit-expiring
 */
export function deficitexpiringEmail(params: Record<string, string>) {
  ...
  const t = templates["deficit-expiring"] ?? { subject: "Notification Talok", body: "" };
