...
CREATE INDEX IF NOT EXISTS idx_invoices_lease_periode
...
CREATE INDEX IF NOT EXISTS idx_invoices_tenant_periode
...
CREATE INDEX IF NOT EXISTS idx_invoices_lease_unpaid
  ON invoices(lease_id, periode DESC)
...
CREATE INDEX IF NOT EXISTS idx_payments_invoice_succeeded
...
CREATE INDEX IF NOT EXISTS idx_cash_receipts_owner_created
...
CREATE INDEX IF NOT EXISTS idx_cash_receipts_tenant_created
...
CREATE INDEX IF NOT EXISTS idx_cash_receipts_periode
...
CREATE INDEX IF NOT EXISTS idx_cash_receipts_receipt_number
