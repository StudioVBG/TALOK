-- ==========================================================
-- Phase 5 — Cosmetic : Email templates, Site content, Landing
-- 6 migrations combinees
...
-- REVIEW: -- Suppression des providers Yousign, SendGrid et Brevo (signature/email intégrés ou non utilisés)
-- REVIEW: -- Les credentials associées sont supprimées en premier (FK)
-- REVIEW: 
-- REVIEW: DELETE FROM api_credentials
-- REVIEW: WHERE provider_id IN (
-- REVIEW:   SELECT id FROM api_providers
-- REVIEW:   WHERE lower(name) IN ('yousign', 'brevo', 'sendgrid')
-- REVIEW: );
-- REVIEW: 
-- REVIEW: DELETE FROM api_providers
-- REVIEW: WHERE lower(name) IN ('yousign', 'brevo', 'sendgrid');
-- REVIEW: 
