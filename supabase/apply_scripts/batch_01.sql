...
-- Le rejouer ici (apply_scripts) crée des doublons car la table n'avait pas
-- de UNIQUE (provider_type, document_type) à l'origine — ce qui rendait
-- ON CONFLICT DO NOTHING inopérant. Cf. migration 20260426160000.
