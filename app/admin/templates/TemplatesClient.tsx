...
const TEMPLATE_CONFIGS = {
  ...
  etudiant: {
    ...
    bgGradient: "from-cyan-50 to-sky-100 dark:from-cyan-900/50 dark:to-sky-900/50",
    accent: "#0891b2",
    accentLight: "#67e8f9",
    features: [
    ...
    legalRef: "Art. 25-9 Loi 1989",
  },
  parking: {
    name: "Parking / Garage",
    description: "Location d'emplacement de stationnement",
    icon: Home,
    gradient: "from-gray-600 via-zinc-500 to-stone-500",
    bgGradient: "from-gray-50 to-zinc-100 dark:from-gray-900/50 dark:to-zinc-900/50",
    accent: "#71717a",
    accentLight: "#a1a1aa",
    features: [
      { label: "Durée", value: "Libre", icon: Clock },
      { label: "Préavis", value: "1 mois", icon: Scale },
      { label: "Dépôt", value: "Libre", icon: Shield },
    ],
    legalRef: "Code civil, Art. 1709",
  },
  commercial: {
    name: "Bail Commercial",
    description: "Bail pour activité commerciale, artisanale ou industrielle",
    icon: Briefcase,
    gradient: "from-emerald-600 via-green-500 to-teal-500",
    bgGradient: "from-emerald-50 to-green-100 dark:from-emerald-900/50 dark:to-green-900/50",
    accent: "#059669",
    accentLight: "#6ee7b7",
    features: [
      { label: "Durée minimum", value: "9 ans", icon: Clock },
      { label: "Révision", value: "Triennale", icon: Scale },
      { label: "Renouvellement", value: "Droit au bail", icon: Shield },
    ],
    legalRef: "Code de commerce, Art. L145-1",
  },
  commercial_3_6_9: {
    name: "Commercial 3/6/9",
    description: "Bail commercial classique avec périodes triennales",
    icon: Briefcase,
    ...
    accentLight: "#34d399",
    features: [
      { label: "Durée", value: "9 ans (3+3+3)", icon: Clock },
      { label: "Résiliation", value: "Tous les 3 ans", icon: Scale },
      { label: "Indemnité", value: "D'éviction", icon: Shield },
    ],
    legalRef: "Code de commerce, Art. L145-4",
  },
  commercial_derogatoire: {
    name: "Bail Dérogatoire",
    description: "Bail commercial de courte durée (max 3 ans)",
    icon: Briefcase,
    ...
    features: [
      ...
      { label: "Renouvellement", value: "Non applicable", icon: Scale },
      { label: "Statut", value: "Hors statut", icon: Shield },
    ],
    legalRef: "Code de commerce, Art. L145-5",
  },
  professionnel: {
    name: "Bail Professionnel",
    description: "Pour professions libérales et activités non commerciales",
    icon: Briefcase,
    ...
    features: [
      ...
      { label: "Préavis", value: "6 mois", icon: Scale },
      { label: "Résiliation", value: "À tout moment", icon: Shield },
    ],
    legalRef: "Art. 57 A Loi 1986",
  },
  location_gerance: {
    name: "Location-Gérance",
    description: "Exploitation d'un fonds de commerce par un tiers",
    icon: Briefcase,
    gradient: "from-amber-600 via-yellow-500 to-orange-500",
    bgGradient: "from-amber-50 to-yellow-100 dark:from-amber-900/50 dark:to-yellow-900/50",
    accent: "#d97706",
    accentLight: "#fbbf24",
    features: [
      { label: "Durée", value: "Libre (2 ans usuel)", icon: Clock },
      { label: "Redevance", value: "Fixe ou %CA", icon: Scale },
      { label: "Publication", value: "Obligatoire", icon: Shield },
    ],
    legalRef: "Code de commerce, Art. L144-1",
  },
  bail_mixte: {
    name: "Bail Mixte",
    description: "Usage mixte habitation et professionnel",
    icon: Home,
    gradient: "from-teal-600 via-emerald-500 to-green-500",
    bgGradient: "from-teal-50 to-emerald-100 dark:from-teal-900/50 dark:to-emerald-900/50",
    accent: "#0d9488",
    accentLight: "#5eead4",
    features: [
      { label: "Durée minimum", value: "3 ans", icon: Clock },
      { label: "Usage", value: "Habitation + pro", icon: Scale },
      { label: "Loi applicable", value: "Loi 1989", icon: Shield },
    ],
    legalRef: "Art. 2 Loi 1989",
  },
  bail_mobilite: {
    name: "Bail Mobilité (alias)",
    description: "Location temporaire pour personnes en mobilité",
    icon: Home,
    gradient: "from-indigo-600 via-purple-500 to-pink-500",
    bgGradient: "from-indigo-50 to-purple-100 dark:from-indigo-900/50 dark:to-purple-900/50",
...
} as const satisfies Record<TypeBail, unknown>;
