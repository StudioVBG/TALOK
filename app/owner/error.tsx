...
/**
 * Page d'erreur pour le tableau de bord Proprietaire
 * Capture les erreurs non gerees dans la section proprietaire
 */
export default function OwnerError({
  ...
  useEffect(() => {
    logger.error("Owner dashboard error", {
      error,
      digest: error.digest,
      section: "owner",
    });
    ...
    <div className="flex items-center justify-center min-h-[60vh] p-4">
      <Card className="w-full max-w-lg shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Erreur dans votre espace Proprietaire</CardTitle>
          <CardDescription>
