...
/**
 * Page d'erreur pour le tableau de bord Propriétaire
 * Capture les erreurs non gérées dans la section propriétaire
 */
    ...
    <div className="flex items-center justify-center min-h-[60vh] p-4">
      <Card className="w-full max-w-lg shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Erreur dans votre espace Propriétaire</CardTitle>
          <CardDescription>
