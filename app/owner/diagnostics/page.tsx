                  ...
                  <div className="flex items-center">
                    ...
                    <div className="p-6 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        ...
                        <span className="text-sm text-muted-foreground capitalize">{property.type}{property.nb_pieces ? ` • ${property.nb_pieces} p.` : ''}{property.surface ? ` • ${property.surface}m²` : ''}</span>
                      </div>
                    </div>
                    <div className="pr-6">
