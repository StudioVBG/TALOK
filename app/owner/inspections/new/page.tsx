...
async function WizardContent({ profileId, preselectedLeaseId, preselectedType }: { profileId: string; preselectedLeaseId?: string; preselectedType?: "entree" | "sortie" }) {
  const leases = await fetchLeases(profileId);
  return <CreateInspectionWizard leases={leases} preselectedLeaseId={preselectedLeaseId} preselectedType={preselectedType} />;
}
...
export default async function NewInspectionPage({
  ...
  const preselectedType = resolvedSearchParams?.type as "entree" | "sortie" | undefined;
