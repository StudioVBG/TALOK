    ...
    >
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            { label: "Mes missions", href: "/app/provider/jobs", icon: Briefcase },
            { label: "Mes factures", href: "/app/provider/invoices", icon: FileText },
            { label: "Calendrier", href: "/app/provider/calendar", icon: Calendar },
            { label: "Mes avis", href: "/app/provider/reviews", icon: Star },
          ].map((link) => (
