      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <Link href="/app/syndic/onboarding/profile">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <QuickAction
                      ...
                      href="/app/syndic/expenses/new"
                      color="emerald"
                    />
                    <QuickAction
                      icon={Euro}
                      label="Appel de fonds"
                      href="/app/syndic/calls/new"
                      color="amber"
                    />
                    <QuickAction
                      icon={Calendar}
                      label="Planifier une AG"
                      href="/app/syndic/assemblies/new"
                      color="violet"
                    />
                    <QuickAction
                      icon={Users}
                      label="Inviter un copro"
                      href="/app/syndic/invites"
                      color="cyan"
                    />
                  </div>
                </CardContent>
            ...
            >
              <Card className="border-white/10 bg-white/5">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Link href="/app/syndic/assemblies">
                    <Button 
                      variant="ghost" 
