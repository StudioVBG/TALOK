...
export default function EditAssemblyPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push(`/app/syndic/assemblies/${assemblyId}`);
    } catch (error) {
      toast({
        title: "Erreur",
      ...
      <div className="p-6">
        <Card className="bg-white/80 backdrop-blur-sm">
          <CardContent className="py-16 text-center">
            ...
            <Button asChild>
              <Link href="/app/syndic/assemblies">Retour aux assemblées</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          <Link
            href={`/app/syndic/assemblies/${assemblyId}`}
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3 justify-end">
            <Button variant="outline" asChild>
              <Link href={`/app/syndic/assemblies/${assemblyId}`}>Annuler</Link>
            </Button>
            <Button
              onClick={handleSave}
              disabled={saving}
