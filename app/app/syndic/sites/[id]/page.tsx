        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" asChild>
              <Link href={`/app/syndic/sites/${siteId}/edit`}>
            ...
            <Button
              ...
              asChild
            >
              <Link href={`/app/syndic/assemblies/new?siteId=${siteId}`}>
            ...
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button size="sm" asChild>
                  <Link href={`/app/syndic/onboarding/units?siteId=${siteId}`}>
          ...
          <TabsContent value="owners">
            <Card className="bg-white/80 backdrop-blur-sm">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button size="sm" asChild>
                  <Link href={`/app/syndic/invites?siteId=${siteId}`}>
                    <Plus className="mr-2 h-4 w-4" />
                    Inviter
                  </Link>
                </Button>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Button variant="outline" className="h-24 flex-col" asChild>
                    <Link href={`/app/syndic/calls/new?siteId=${siteId}`}>
                      <Euro className="h-6 w-6 mb-2" />
                      Nouvel appel de fonds
                    </Link>
                  </Button>
                  <Button variant="outline" className="h-24 flex-col" asChild>
                    <Link href={`/app/syndic/expenses/new?siteId=${siteId}`}>
