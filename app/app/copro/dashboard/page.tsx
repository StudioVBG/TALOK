            ...
            <CardContent className="p-6">
              ...
              {data?.nextAssembly && (
                <div className="space-y-2">
                  ...
                  <Link href={`/app/copro/assemblies/${data.nextAssembly.id}`}>
