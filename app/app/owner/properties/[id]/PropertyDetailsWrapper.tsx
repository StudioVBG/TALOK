...
export function PropertyDetailsWrapper({ 
  ...
  const handleEditClick = () => {
    ...
    router.push(`/app/owner/properties/${propertyId}/edit`);
  };
  ...
  return (
    <>
      <PropertyDetailsView
        ...
        // URLs Owner
        backHref="/app/owner/properties"
        backLabel="Retour à la liste"
        editHref={`/app/owner/properties/${propertyId}/edit`}
        createLeaseHref={`/app/owner/contracts/new?propertyId=${propertyId}`}
        viewLeaseHref={(leaseId) => `/app/owner/contracts/${leaseId}`}
