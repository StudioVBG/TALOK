...
export default async function LeasePreviewPage({ params }: PageProps) {
  ...
  try {
    ...
    console.error("Error loading lease preview:", error);
    return (
      <div className="container mx-auto py-12 text-center">
...
export const metadata = {
  title: "Aperçu du bail | Gestion Locative",
  description: "Visualisez et téléchargez votre contrat de bail",
};
