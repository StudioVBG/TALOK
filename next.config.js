...
const nextConfig = {
  ...
  async headers() {
    return [
        ...
        headers: [
          {
            ...
            value: [
              ...
              "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://*.supabase.co https://*.supabase.in https://challenges.cloudflare.com blob:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.googleapis.com https://api-adresse.data.gouv.fr https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org https://api.stripe.com https://*.ingest.sentry.io",
      ...
      // Universal Links (iOS) et App Links (Android) — requis par Capacitor
      {
