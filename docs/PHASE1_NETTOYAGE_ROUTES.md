...
1. ✅ **`app/properties/new/page.tsx`** (ancien doublon)
   - **Raison** : Doublon de `/app/owner/properties/new`
...
1. ✅ **`app/app/owner/properties/[id]/edit/page.tsx`**
...
1. ✅ **`app/properties/[id]/preview/page.tsx`**
   - Ligne 86 : `router.push("/properties")` → `router.push("/app/owner/properties")`
   - Ligne 235 : `router.push("/properties")` → `router.push("/app/owner/properties")`
...
|-------|-------------|--------|
| `/app/owner/properties` | Liste des logements | ✅ Canonique |
| `/app/owner/properties/new` | Ajout de logement | ✅ Canonique |
| `/app/owner/properties/[id]` | Détail d'un logement | ✅ Canonique |
| `/app/owner/properties/[id]/edit` | Édition d'un logement | ✅ Canonique (nouveau) |

### ✅ Routes Legacy (Redirections)

| Route Legacy | Redirige vers | Statut |
|--------------|---------------|--------|
| `/properties` | `/app/owner/properties` | ✅ Redirection |
| `/properties/new` | `/app/owner/properties/new` | ✅ Redirection |
| `/properties/[id]` | `/app/owner/properties/[id]` | ✅ Redirection |
| `/properties/[id]/edit` | `/app/owner/properties/[id]/edit` | ✅ Redirection |
...
- Vérifier `app/app/owner/properties/_actions.ts`
