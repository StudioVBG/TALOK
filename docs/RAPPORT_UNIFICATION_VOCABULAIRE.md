...
| `Contract` / `contract` | Routes Next.js (`/app/owner/contracts/`) | Route pour baux | ⚠️ `contracts` (route) | ⚠️ **À DÉCIDER** |
...
- `app/app/owner/contracts/page.tsx` → `app/app/owner/leases/page.tsx`
- `app/app/owner/contracts/ContractsPageClient.tsx` → `app/app/owner/leases/LeasesPageClient.tsx`
- `app/app/owner/contracts/[id]/page.tsx` → `app/app/owner/leases/[id]/page.tsx`
- `app/app/owner/contracts/[id]/ContractDetailPageClient.tsx` → `app/app/owner/leases/[id]/LeaseDetailPageClient.tsx`
